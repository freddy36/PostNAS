...
DELETE FROM user_sdo_geom_metadata WHERE upper(table_name)='AX_SONSTIGESBAUWERK_FUNKTION(';
BEGIN EXECUTE IMMEDIATE 'DROP TABLE AX_SONSTIGESBAUWERK_FUNKTION( CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
